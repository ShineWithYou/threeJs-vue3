...
/* 
  相机设置
*/
const width = window.innerWidth * 0.8 // 窗口宽度
const height = window.innerHeight * 0.8 // 窗口高度
...
function render() {
  ...
  document.getElementById('pos').appendChild(renderer.domElement) // body元素中插入canvas对象
